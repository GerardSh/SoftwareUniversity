...
Console.WriteLine("Choose field size - press 's' + Enter for small, 'm' + Enter for medium and 'l' + Enter for large");
...
PrintTitle();
Console.WriteLine("Choose your character outlook, it can be any symbol!");
