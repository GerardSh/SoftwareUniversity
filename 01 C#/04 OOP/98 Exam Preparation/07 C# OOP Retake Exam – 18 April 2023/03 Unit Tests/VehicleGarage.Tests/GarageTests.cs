...
namespace VehicleGarage.Tests
{
    public class GarageTests
    {
        ...
        [Test]
        public void DriveVehicleMethodShouldReturnCorrectValues()
        {
            garage.AddVehicle(vehicle);
            garage.DriveVehicle("license", 20, true);

            Assert.That(vehicle.BatteryLevel, Is.EqualTo(80));
            Assert.That(vehicle.IsDamaged, Is.True);

            Vehicle vehicle2 = new Vehicle("brand", "model", "license2");
            ...
            Assert.That(vehicle2.BatteryLevel, Is.EqualTo(80));
            Assert.That(vehicle2.IsDamaged, Is.False);

            vehicle.BatteryLevel = 100;
            garage.DriveVehicle("license", 20, false);
