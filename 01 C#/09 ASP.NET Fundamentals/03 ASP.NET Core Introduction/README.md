...
Създаваме `WebApplicationBuilder`, който ни позволява да конфигурираме най-различни аспекти на приложението – например добавяне на сървиси.
