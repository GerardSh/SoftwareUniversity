...
>Ако видим това предупреждение, трябва да внимаваме и да прегледаме кода на миграцията за точност.
## Applying Migrations
...
>[!WARNING]
>Не е добра идея да се пипа по схемата на базата данни чрез миграциите, защото ако по някаква причина трябва да изтрием миграциите и да рестартираме базата, тези промени няма да бъдат отразени, ако са били направени чрез модифициране на изтритите миграции.
>
