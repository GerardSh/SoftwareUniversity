namespace AcademicRecordsApp.Data
{
    ...
    public partial class AcademicRecordsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__Exams__3214EC07C5E6C066");
            ...
            {
                entity.HasKey(g => g.Id).HasName("PK__Grades__3214EC0787AABF83");

                entity.Property(g => g.Value).HasColumnType("decimal(3,2)");

                entity.HasOne(g => g.Exam).WithMany(e => e.Grades)
            ...
            {
                entity.HasKey(s => s.Id).HasName("PK__Students__3214EC07A3F0B260");
