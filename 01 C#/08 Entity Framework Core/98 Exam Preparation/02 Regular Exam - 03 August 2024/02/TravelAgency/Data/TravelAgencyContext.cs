...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=.;Database=TravelAgency;User Id=sa;Password=r3F4iJbYas&#aRj^bmjj;TrustServerCertificate=true;";
        ...
        {
            modelBuilder.Entity<TourPackageGuide>().HasKey(tg => new { tg.TourPackageId, tg.GuideId });
