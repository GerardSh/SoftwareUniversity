...
namespace NetPay.Data
{
    ...
    {
        private const string connectionString = @"Server=.;Database=NetPay;User Id=sa;Password=r3F4iJbYas&#aRj^bmjj;TrustServerCertificate=true;";
        ...
        {
            //Fluent API here
            modelBuilder.Entity<SupplierService>().HasKey(ss => new { ss.SupplierId, ss.ServiceId });
