...
### Reading XML
Може да го заредим по няколко начина - от файл, може да го получим от request през HTTP протокола. Може да го получим и просто като стринг. Кавичките се escape-ват автоматично. Ако е стринг се парсва, ако е файл се load-ва.
