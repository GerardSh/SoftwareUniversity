...
Този селектор таргетира всички елементи, които са "събратя" на даден елемент, но не е задължително да са непосредствено след него.
...
Всички `<p>` елементи, които са "събратя" (следват в същия родителски елемент) на даден `<p>` елемент, ще имат светлозелен фон. Те не е нужно да са непосредствено след първия `<p>` елемент, за да бъдат стилизирани.
