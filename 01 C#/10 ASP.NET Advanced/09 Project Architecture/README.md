...
**Microservices** са архитектура, базирана на множество малки приложения. Това е най-гъвкавата архитектура, но и най-трудна за деплой.
...
Колекция от слабо свързани услуги.

Размерът им трябва да бъде минимален.

Позволяват непрекъснат деплоймънт.

Могат да се деплойват независимо едно от друго.

Всички услуги комуникират директно.

Всяка услуга има собствена база данни.
