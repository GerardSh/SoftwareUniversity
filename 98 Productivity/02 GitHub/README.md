...
При клониране на repository му се дава име, което е [origin](https://github.com/GerardSh/SoftwareUniversity/blob/main/98%20Productivity/02%20GitHub.md##Remotename) по default. Ако имаме повече от едно локално repository, трябва да сменим името, за да не стават конфликти. 
